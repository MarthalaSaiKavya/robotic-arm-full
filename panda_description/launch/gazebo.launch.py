...
def generate_launch_description():
    ...
    # Run with mock hardware by default to avoid ros2_control plugin crashes on this platform.
    use_mock_hw = os.environ.get("PANDA_USE_MOCK_HW", "1")
    is_ignition = "True"  # Irrelevant when mocking hardware
